...
export default function FancyLock(props) {
  ...
  return (
    <div className="modal" id="fancyLock">
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h6 className="modal-title text-dark" style={{display:'flex'}}>Lock Fancy of <p className="text-success">{props.data}</p></h6>
            <button
              type="button"
              className="btn-close"
          ...
          <div className="modal-body">
            ...
            <div className="form-floating mb-3">
              Want to lock Fancy of the user {props.data}
            </div>
            <button
              type="submit"
